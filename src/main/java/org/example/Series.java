    ...
    public void UpdateSeries() {
        ...
        if (found != null) {
            ...
            while (true) {
                ...
                if (isValidAge(age))
                    break;
                System.out.println("Tou have entered a incorrect series age !");
                System.out.println("Please re-enter the series age");
            }
            found.SeriesAge = age;
    ...
    public void DeleteSeries() {
        ...
        if (found != null) {
            ...
            if (confirm.equalsIgnoreCase("Y")) {
                ...
                System.out.println("Series with Seres id " + id + " was deleted!");
            } else {
                System.out.println("Delection cancelled. ");
            }
        } else {
            System.out.println(" Series with Series id: " + id + " was not found!");
